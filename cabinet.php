...
<body>
            ...
            <div class="row">
                ...
                <div class="col s12 center-align">
                    <button id="logout" class="waves-effect waves-light btn">
                        <i class="material-icons right">keyboard_tab</i>Logout
                    </button>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 right-align">
                                <button id="signup-submit" class="waves-effect waves-light btn">
                                    <i class="material-icons right">cloud</i>update
                                </button>
                            </div>
                        </div>
                    </form>
    ...
    <script src="script/get_user_data.min.js"></script>
    <script src="script/logout.min.js"></script>
</body>
