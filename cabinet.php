                ...
                <div class="g-top-header__column g-header-nav">
                    <div class="g-header-nav__content">
                        <nav class="g-header-nav__column">
                            ...
                            <li><a href='https://github.com/NightMareStories/Cabinet-on-JavaScript.git' class="g-actions-header__link" target="_blank" rel="noopener noreferrer"><span>GitHub</span></a></li>
        ...
        <div class="general-footer__content g-content-footer _container">
            <div class="g-content-footer__block g-block-footer">
                ...
                <nav class="g-block-footer__nav">
                    ...
                    <li><a href='https://github.com/NightMareStories/Cabinet-on-JavaScript.git' class="g-actions-footer__link" target="_blank" rel="noopener noreferrer"><span>GitHub</span></a></li>
